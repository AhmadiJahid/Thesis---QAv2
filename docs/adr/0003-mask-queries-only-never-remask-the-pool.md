...
- **Dynamically masking the pool at runtime** — rejected in v1 because KB entity overlap corrupts pool items (the "Baby Face"/"Stars" example above), silently degrading the retrieval pool.
